...
OBJS := src/main.o src/lexer.o src/parser.tab.o src/ast.o src/eval.o
...
src/main.o: src/main.c include/ast.h include/eval.h include/lexer.h
	$(CC) $(CFLAGS) -c $< -o $@
...
src/eval.o: src/eval.c include/eval.h include/ast.h
	$(CC) $(CFLAGS) -c $< -o $@
