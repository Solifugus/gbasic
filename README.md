...
GUI — and forty-eight pure-gBASIC libraries covering double-entry accounting, loan
...
**123 test suites** gate every change, goldens are byte-exact, and the claims in
...
Forty-eight pure-gBASIC libraries in `stdlib/`. Each bullet says what backs it,
...
**Use `run_all.sh` rather than naming suites.** It discovers all 123 suites by
