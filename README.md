...
GUI — and forty-seven pure-gBASIC libraries covering double-entry accounting, loan
...
**121 test suites** gate every change, goldens are byte-exact, and the claims in
...
Forty-seven pure-gBASIC libraries in `stdlib/`. Each bullet says what backs it,
...
**Use `run_all.sh` rather than naming suites.** It discovers all 121 suites by
