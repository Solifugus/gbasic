...
function registry_entry()
    return { id: "iso20022.camt053",
             ...
             test_vectors: [
               { name: "tests/finio/camt/*.xml",
                 source_url_or_reference: "generated by tools/make_camt_fixture.py in this repository",
                 date_retrieved: "2026-09-14",
                 licence: "Apache-2.0 (this project)",
                 usage: "permitted", redistribution: "permitted",
                 note: "written here. NO FOREIGN camt.053 VECTOR HAS BEEN OBTAINED: the Goldman Sachs published samples returned HTTP 403 to an automated fetch on 2026-09-15, which is UNAVAILABILITY AND NOT A PROHIBITION -- a person may retrieve them by hand. Until one is read this adapter has still never met a bank's statement, which is why its recognition_status and read_status stay `implemented` where the NACHA adapter's are now `verified`." } ],
             known_variants: [],
             known_extensions: [],
