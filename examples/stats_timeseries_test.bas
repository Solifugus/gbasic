...
program demo(args)
    ...
    hw = holt_winters(ws, 0.5, 0.3, 0.2, 4, 4)
    ...
    print("guard_sma " + string(sma(a, 0)))
    print("guard_ewma " + string(ewma(a, 1.5)))
    print("guard_acf " + string(acf(a, 20)))
    print("guard_hw " + string(holt_winters(ws, 0.5, 0.3, 0.2, 10, 4)))
end program
