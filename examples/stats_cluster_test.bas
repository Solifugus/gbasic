...
program demo(args)
    ...
    zo = stats.zscore_outliers(obs, 2.5)
    ...
    print("guard_km " + string(stats.kmeans(dk, 0, 10)))
    print("guard_pca " + string(stats.pca(dp, 5)))
    print("guard_hier " + string(stats.hierarchical(dh, "ward")))
end program
