...
program demo(args)
    ...
    print("guard_prop1 " + string(prop_test_1(5, 0, 0.5)))
    print("guard_funnel " + string(funnel([])))
    print("guard_rfm " + string(rfm([])))
end program
