...
program demo(args)
    ...
    print("guard_twoway " + string(stats.anova_twoway([ [ [1, 2], [3, 4] ] ])))
    print("guard_rm " + string(stats.anova_repeated([ [1, 2, 3] ])))
    print("guard_tukey " + string(stats.tukey_hsd([ [1, 2, 3] ])))
end program
